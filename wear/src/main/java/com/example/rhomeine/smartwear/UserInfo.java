...
public class UserInfo {
    ...
    public static boolean init_flag = Boolean.FALSE;
...
//        TimeStamp = Calendar.getInstance().getTimeInMillis();
    ...
    public static void initUser(int age){
        Weight_kg = 0;
        Age = age;
        Height_cm = 0;
        Gender = "Null";
    ...
    public static Map<String,String> getUserData(){
        ...
        userMap.put("Timestamp",Long.toString(getTimeStamp()));
        return userMap;
    ...
    public static List<Map<String,String>> getMyData2(){
    ...
    public static void setAge(int age) {
        Age = age;
        MAX_HEART_RATE = 220-Age;
        HeartRateTraining.UpdateUserGroup();
