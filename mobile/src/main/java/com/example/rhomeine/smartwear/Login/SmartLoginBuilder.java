...
public class SmartLoginBuilder {
    ...
    public static SmartCustomLogoutListener smartCustonLogoutListener;
    ...
    public SmartLoginBuilder setSmartCustomLogoutHelper(SmartCustomLogoutListener mSmartCustomLogoutListener){
        SmartLoginBuilder.smartCustonLogoutListener = mSmartCustomLogoutListener;
        return  this;
    }
